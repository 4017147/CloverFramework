		 ...
		 demo.setF7("f7");
			...
			CourseProxy<User,Course> cp = new CourseProxy<User,Course>(new CourseProxyTest()) {{
				Thread t1 = new Thread(new Runnable() {
					...
					@Override
					public void run() {
						Master("a1").get(demo.getF9(),count(demo.getF2()),DEMO.f1,DEMO.f4,count(DEMO.f3))
						.by(DEMO.f10,demo.getF10()).eq(40,$$(demo.getF5())).and(demo.getF5(),$$(demo.getF5())).eq(1,2).and(DEMO.f3);
				...
				Thread t2 = new Thread(new Runnable() {
					...
					public void run() {
						//Course b = Master("b");
						Master("a1").get(demo.getF7(),count(demo.getF2()),DEMO.f1,DEMO.f4,count(DEMO.f3))
						.by(DEMO.f10,demo.getF10()).eq(50,$$(demo.getF6())).and(demo.getF6(),$$(demo.getF6())).eq(3,4).and(DEMO.f3);
